        ...
        <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
            <div class="col-12">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form
                        action="{{url("/categories/$category->category_id/category_images/$categoryImage->category_image_id")}}"
                        method="POST"
                        ...
                        <input type="hidden" name="category_image_id" value="{{$categoryImage->category_image_id}}">
                        <div class="mb-3">
                            <img src="{{asset("/storage/categories/$categoryImage->image_url")}}" alt="{{$categoryImage->alt}}"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control bg-dark" type="file" id="image_url" name="image_url"
                                   value="{{old("image_url",$categoryImage->image_url)}}">
                            @error("image_url")
                        ...
                        <div class="mb-3">
                            ...
                            <input name="alt" type="text" class="form-control" id="alt"
                                   value="{{old("alt",$categoryImage->alt)}}">
                        </div>
                        <br>
