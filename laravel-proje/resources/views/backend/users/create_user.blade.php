                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form action="{{url("/users")}}" method="POST">
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="passwordCheck1">
                                <label  class="form-check-label" for="passwordCheck1">Göster</label>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword2" class="form-label">Şifre Tekrarı</label>
                                <input name="password2" type="password" class="form-control" id="exampleInputPassword2">
                            </div>
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="passwordCheck2">
